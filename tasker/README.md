...
| Tracker                                                                                              | Remaining kernel                                                                                                                                                                                                                                                                                                                                                                   |
| ---------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [104 — Supabase fitness](104-supabase-fitness-sizing-and-efficiency.md)                              | **Claude (took over from Codex).** Security containment LIVE in prod (anon refused, verified). Lock-first and onboarding migrations applied; only Libri quota is held, on purpose. Wake-aware 5 s polling shipping. DJ retired QA in favor of prod testing: migration rehearsal replaces it. Open: post-deploy polling check, busy-window sizing sample, stream-state HOT updates. |
