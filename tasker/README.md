...
| Tracker                                                                                              | Remaining kernel                                                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [104 — Supabase fitness](104-supabase-fitness-sizing-and-efficiency.md)                              | **Codex — audit + follow-up delivered; implementation/busy-window validation pending.** [Work order](../docs/technical/reviews/SUPABASE_WORK_ORDER_AND_QUEUE_WAKE_2026-09-24.md): keep QA; contain 3 live security exposures; maintenance RPCs now healthy; finish chat reliability, then replace 1 s idle polling with wake-aware safety polling. All 4 chat workers receive wakes; delegated Agent Runs use the separate 5 s general queue. |
