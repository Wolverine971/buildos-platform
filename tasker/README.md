...
| [37](37-agent-first-orchestration-phase-a.md)       | Agent-first orchestration       | **Actively in progress** (dedicated agent). WP-1…WP-3 complete; DJ gates 1 and 2 passed 7/24.                                                                                                                                                      | WP-4 control-lane baselines → WP-5 decision rule → A1/A2. Leave this one alone.                                                                                                      |
