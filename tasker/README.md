...
| [37](37-agent-first-orchestration-phase-a.md)       | Agent-first orchestration       | **CLOSED 2026-07-26.** Routing gate recorded instrument-limited (65/72 arithmetically unreachable; 3/13 labels contested). A2 never scored; hypothesis neither corroborated nor falsified. Decision: `PHASE_A_RESULTS.md`.                          | Quality question continues in the open-brief instrument (Tier 2). No further routing cohorts.                                                                                        |
