...
2. Next specialist contracts, especially sections 2 and 6.
3. September 21 reassessment.
4. Original September 19 audit, as historical context; several implementation gaps have since been addressed.
...
Start with the completion-receipt proposal.
...
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Read ownership checks         | `apps/worker/src/workers/agentic-chat/turn/turn-executor.ts`: `assertCurrentReadToolFence`, `awaitOverhead`, and both call sites                                                                                                                                |
| Claim RPC and persistence     | `apps/worker/src/workers/agentic-chat/turn/execution-control.ts`; `promptSnapshot.ts` in the same directory                                                                                                                                                     |
