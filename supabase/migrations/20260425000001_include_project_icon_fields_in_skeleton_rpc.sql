-- supabase/migrations/20260425000001_include_project_icon_fields_in_skeleton_rpc.sql
-- Include project icon metadata in get_project_skeleton for cold loads.
