-- supabase/migrations/20260430000004_remove_brain_dump_search_results.sql
-- Migration: Hide legacy brain_dumps from global search during retention
...
CREATE OR REPLACE FUNCTION public.search_all_content(
	...
	items_per_category integer DEFAULT 5
)
RETURNS TABLE(
	item_type text,
	item_id uuid,
...
CREATE OR REPLACE FUNCTION public.search_by_type(
	search_query text,
	current_user_id uuid,
	search_type text,
