-- supabase/migrations/20260424000008_add_fastchat_context_documents_snapshot.sql
-- Add lightweight document snapshots to load_fastchat_context project payloads.
...
COMMENT ON FUNCTION load_fastchat_context(text, uuid, uuid, text, uuid) IS
	'Loads FastChat V2 context payload in a single round trip, including project members and lightweight document snapshots.';
