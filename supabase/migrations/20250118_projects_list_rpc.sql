-- Create optimized RPC function for projects list with task statistics
-- This eliminates fetching all tasks for each project
...
COMMENT ON FUNCTION get_projects_with_stats IS 'Optimized function to fetch projects with pre-calculated task statistics, eliminating the need to fetch all tasks for counting';
