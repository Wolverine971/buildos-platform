-- supabase/migrations/20260325000000_fix_project_invite_accept_upsert.sql
-- Migration: Avoid ambiguous project_id in invite acceptance upsert
-- Date: 2026-03-25
-- Description: Replace ON CONFLICT upsert with explicit update/insert in accept_project_invite.
