...
- **Todoist / Things** — the "they already have this" baseline for task management — BuildOS's differentiator is structure _from messy input_, not the task list itself
