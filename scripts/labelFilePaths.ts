...
// Character class includes: word chars, dash, dot, slash, plus, space, brackets (for [slug] paths), parentheses (for route groups like (app)), $ (for SvelteKit files like $types.ts)
