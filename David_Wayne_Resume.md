...
Senior full-stack engineer with 8+ years shipping production web applications, with deep React + TypeScript experience and a track record owning enterprise integrations end-to-end. At Curri I built the integration layer that connected our delivery network to Lyft, Uber, DoorDash, and five regional partners — and rebuilt the live ops dashboard the company ran on. Currently founder of **BuildOS**, an AI-native productivity platform built on a multi-LLM routing layer, an agentic chat that reads and writes user calendars, and a custom Supabase-native job queue. Former US Marine Corps Scout Sniper Team Leader.

---

## Technical Skills

- **Frontend:** React, Next.js, TypeScript, Redux-pattern state management (VueX, NgRx, Svelte stores), Vue 2/3, AngularJS, Angular, Svelte/ SvelteKit, Tailwind, real-time UIs (SSE, WebSockets)
...
### Curri — Software Engineer · Jan 2022 – Feb 2025
...
_Military Justice Case Management System (Department of Defense client)_

- Performed substantial **data migrations of legacy case data** into the production case management system used by military lawyers to look up case and trial information across the DoD military justice system.
...
- Worked in an Angular + **NgRx** codebase with heavy state-management and visualization concerns.
...
- **Sabio Coding Bootcamp** (partnered with Antioch University) — Web Development Certificate. Founder-led, taught by a senior industry developer. Took me from zero to production in 6 months and launched my software career.
...
- **[9takes.com](https://9takes.com)** — Reddit-style discussion site organized around the Enneagram personality framework. 15K+ monthly unique visitors, 1,500+ weekly uniques, 100+ registered users. Built and operated solo.
