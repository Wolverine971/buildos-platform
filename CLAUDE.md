...
- **Worker** (`src/worker.ts`) — Supabase queue consumer processing jobs (briefs + audio narration, braindumps, notifications, chat classification, voice transcription, OCR, homework, ontology, tree agent, agent runs, project loops, project icons, SMS)
