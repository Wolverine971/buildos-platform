<!-- research-library/design-current-priorities-brainstorm.md -->
...
**Source:** `docs/research-library/research/research-beyond-prompt.md`
...
**Source:** `docs/research-library/research/research-learning.md`
...
**Inspiration:** Steve Yegge's Gas Town launch (`docs/research-library/blogs/blog-gas-town.md`)
...
- `docs/research-library/research/research-beyond-prompt.md` - Research on LLM variable limits
- `docs/research-library/research/research-learning.md` - Research on LLM iterative understanding
- `docs/research-library/blogs/blog-gas-town.md` - Steve Yegge's Gas Town anti-marketing inspiration
