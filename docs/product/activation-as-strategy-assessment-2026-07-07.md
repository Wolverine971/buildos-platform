...
| AI Inbox / Project Inbox live-smoke closure                                                                                | tasker 13                                                            | **Supports activation**                                 | Built end-to-end but **never live-smoke-tested; prod migrations unverified**. Verification debt; gates Project Loops exposure. Finish, don't expand. |
...
| Complete Project Audit build / Project Loops production exposure                                                           | tasker 14; project-loops audit                                       | **Distracting until core loop works**                   | Audit core built but **live smoke never run**; loops OFF in prod, unvalidated. Do not broaden before B1–B3.                                          |
...
- Freeze Project Loops production exposure (tasker 14) and any new agent capability / new capture input / new dashboard surface.
...
1. **Is activation the operating center for the next 2–3 weeks — enough to pause the creator-acquisition outbound push (tasker 24) and freeze Project Loops / new agent surface?** (The plan above assumes yes. If no, say what wins instead and why.)
