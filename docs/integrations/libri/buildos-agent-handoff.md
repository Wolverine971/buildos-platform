...
1. Add a server-side Libri client.
   - Keep fetch wrapper small.
   - Normalize base URL.
   - Add request timeout.
   - Return typed errors without secrets.

2. Add `resolve_libri_resource` to internal tool definitions and metadata.
...
4. Update prompts/tool selection.
...
6. Add external gateway support after internal behavior is stable.
   - Add allowed op type.
