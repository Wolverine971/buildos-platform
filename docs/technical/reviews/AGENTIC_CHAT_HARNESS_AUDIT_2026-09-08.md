...
- [E] New shared module apps/worker/src/workers/agentic-chat/effects/pending-effects.ts (this package's AgenticChatPendingEffects + WP-D's registry/singleton); no migrations, views, harness telemetry or canary touched; execution-adapter.ts left byte-identical.
