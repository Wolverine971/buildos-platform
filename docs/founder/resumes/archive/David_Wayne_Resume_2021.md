...
C4 Planning Solutions | Software Engineer | March 2021 – Present
Military Justice Case Management System
Maintained system for Military Lawyers to manage their cases. This includes tackling bugfixes and new features in an Agile environment
Built multiple migration tools for formatting and migrating data
Worked with Vue, jQuery and Sharepoint.
9takes.com | Founder and Developer | February 2019 – Present
Personality Question and Answering Network
Imagined, designed, and developed 9takes.com from front to back
Features include authentication, login, and register, notifications, a question and answering board, with searching, sorting, recursive comments, likes, and subscriptions. Separate content pages supporting image upload, searching, and pagination.
Frontend technology used: Vue.js, Vuetify, and Nuxt. Backend Technology used: Socket.io, Redis, GraphQl, Elasticsearch and MongoDB.  
Webworld Technologies, Inc. | Software Engineer | August 2019 – October 2020
Dewey Knowledge Portal Project- Data Visualization App for the Air Force
Built multiple frontend features in an Agile environment spanning multiple pages.
Created a search and discovery feature which allowed users to create nested search queries that filter through results using specified AND/ OR search logic
Improved analyst workflows by creating tools for documenting classifications and citations, creating dashboards for moving files through change management processes, and by creating templating systems that return custom “wikipedia” style search results
