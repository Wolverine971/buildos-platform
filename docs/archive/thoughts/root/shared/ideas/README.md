<!-- docs/archive/thoughts/root/shared/ideas/README.md -->
# Ideas Index

A catalog of all idea documents in `thoughts/shared/ideas/`, grouped by category.

## Chat

Ideas related to the conversational agent and chat system.
...
Ideas related to the ontology system, project types, and metadata.

| File | Description | Status | Frontmatter |
|------|-------------|--------|-------------|
| [ontology/MY_CURRENT_UNDERSTANDING.md](ontology/MY_CURRENT_UNDERSTANDING.md) | Vision and current understanding of the ontology direction | design-phase | yes |
| [ontology/admin-ontology-graph-view-spec.md](ontology/admin-ontology-graph-view-spec.md) | Cytoscape.js ontology visualization spec for admin panel | design-phase | yes |
| [ontology/buildos-ontology-master-plan.md](ontology/buildos-ontology-master-plan.md) | Ontology master plan v3.1 with simplified 3-facet metadata | design-phase | no |
| [ontology/buildos-outputs.md](ontology/buildos-outputs.md) | Project outputs and deliverables taxonomy (v2) | design-phase | no |
| [ontology/endpoint-stubs.md](ontology/endpoint-stubs.md) | TypeScript endpoint stubs for SvelteKit ontology routes | design-phase | yes |
| [ontology/notebooklm-counter-positioning.md](ontology/notebooklm-counter-positioning.md) | NotebookLM competitive analysis and BuildOS positioning | design-phase | yes |
| [ontology/ontology-implementation-roadmap.md](ontology/ontology-implementation-roadmap.md) | Implementation roadmap with FSM engine and template system | design-phase | yes |

## Features

Ideas related to project features, scaffolding, and context management.
...
Miscellaneous brainstorm and exploration ideas.
