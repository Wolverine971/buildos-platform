<!-- docs/archive/thoughts/root/shared/archive/research-2026-Q1/2026-01-03_00-00-00_modal-field-exposure-audit.md -->
...
### 7. DOCUMENT (`onto_documents`) - Complete
...
```svelte
{#if entity?.props?.tags?.length}
  <div class="flex flex-wrap gap-2">
    {#each entity.props.tags as tag}
