<!-- docs/archive/specs/libri/BUILDOS_LIBRI_DYNAMIC_DISCOVERY_BRIDGE.md -->

> **ARCHIVED 2026-06-22.** Superseded by the 2026-05-21 architectural decision that BuildOS does
> NOT build third-party plugin integrations directly — Corsair (DevJane) brokers all of them.
> The Libri direct-integration approach below is no longer the plan. Kept for historical context.

# BuildOS <> Libri Dynamic Discovery Bridge

Status: proposed implementation handoff (ABANDONED — see archive note above)
