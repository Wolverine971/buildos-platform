...
- **Ryo Lu / Cursor** — _Full Tutorial: Design to Code with Cursor's Head of Design_ ([YouTube, with Peter Yang](https://www.youtube.com/watch?v=bdh8k6DyKxE)). Local transcript: `docs/research-library/transcripts/podcast-ryo-lu-peter-yang.md`.
