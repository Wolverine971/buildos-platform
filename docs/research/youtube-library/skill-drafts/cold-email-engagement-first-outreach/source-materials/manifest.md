...
- 31 active web-source Markdown cards in `source-materials/cleaned/web/`.
- 7 active PDF-source Markdown cards in `source-materials/cleaned/pdf/`.
...
- Legitimate/manual book extractions: April Dunford, Bob Moesta, Rob Fitzpatrick, Brent Adamson, Cialdini, Voss, Pink, Ross, StoryBrand, Made to Stick, full Lean Analytics, and full Trustworthy Online Controlled Experiments.
...
- The active corpus still needs deeper source-analysis memos for the provider/compliance layer, OfferLab, and specialty modes.
