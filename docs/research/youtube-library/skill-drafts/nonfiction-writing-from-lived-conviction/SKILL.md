...
Use this skill to help an agent turn real experience, observation, or memory into creative nonfiction. The goal is not to report facts. The goal is to reveal a particular mind trying to make sense of the world.

## When to Use

- Draft a personal essay or reflective blog post
- Turn a mundane experience into a meaningful essay
- Develop voice, style, or essay form
- Write from memory without making the piece feel like a diary dump
- Shape an opinionated essay around contradiction or ambivalence
- Convert notes, transcripts, or life material into creative nonfiction
...
3. **Construct the speaker.** Decide which traits, contradictions, and limits of the on-page self matter for this piece.
4. **Cut the inessential self.** Remove biographical details that do not intensify the inquiry.
5. **Sharpen contradiction.** Look for places where the speaker wants two incompatible things, believes one thing but does another, or feels both attraction and resistance.
6. **Pick a form.** Use a direct essay, braided essay, one-paragraph microessay, numbered list, letter, field guide, recipe, FAQ, fake academic paper, or other hermit-crab form if the container adds energy.
...
- Do not make the piece a chronological dump.
- Do not hide behind research when the piece needs perspective.
...
Distilled from Writing with Andrew's [I'm Politely Begging You to Write Nonfiction](https://www.youtube.com/watch?v=WIP_hLaLnLo), with local transcript and analysis under `docs/marketing/growth/research/youtube-transcripts/2025-07-21-andrew-write-nonfiction.md`.
