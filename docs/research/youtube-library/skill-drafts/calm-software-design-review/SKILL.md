...
- **Steph Ango / Obsidian — _Toolmaking, Constraints, File-Over-App_** — supporting source. Constraint-driven creativity, file-over-app permanence, malleable-software thinking, plain-text primitives over feature accumulation. Local transcript: [`docs/research-library/transcripts/podcast-steph-ango-obsidian.md`](../../../../research-library/transcripts/podcast-steph-ango-obsidian.md).
