...
4. **Non-follower opening test.** Read the first 5 seconds (video) or first sentence (text) as a stranger who has never seen this creator. Does it make sense? Is there a clear topic + relevance signal?
