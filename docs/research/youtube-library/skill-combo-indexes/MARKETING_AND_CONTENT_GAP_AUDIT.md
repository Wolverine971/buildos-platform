...
- **Anti-feed / interest-media diagnosis.** [Devin Nash's clipping-economy analysis](../transcripts/2026-04-16-exposing-the-new-manufactured-viral-content-economy.md) plus the two [BuildOS](../../../../apps/web/src/content/blogs/philosophy/your-morning-without-the-algorithm.md) [philosophy](../../../../apps/web/src/content/blogs/philosophy/social-media-is-dead-interest-media.md) essays give a citable, receipts-backed case that "social media" has become "interest media" — paid-clipper economies, algorithmic importance arbitrage, and the FTC overhang. This is the strongest "what is broken" stack in the BuildOS library.
...
| Run a notice → know → rate KPI playbook                                                        | Daniel Priestley "How To Get Noticed" (transcript + analysis, 2026-06-11) | none — analysis at `../analyses/2026-06-11_daniel-priestley_million-dollar-playbook_analysis.md` | low      |
...
| `funnel-teardown-and-offer-conversion` (advance) | Daniel Priestley "How To Get Noticed" ANALYSIS available at `../analyses/2026-06-11_daniel-priestley_million-dollar-playbook_analysis.md`; layer copy-craft sources | Analysis condition met 2026-06-11; combo is `ready-to-draft` with the KPI playbook (LAPS, ACPL/ACPS, notice→know→rate) stacked in.               |
...
`ready-to-draft` for `funnel-teardown-and-offer-conversion`. **Updated 2026-04-29:** April Dunford sales pitch framework now stacked into this combo, providing the Setup → Follow-Through structure. Daniel Priestley KPI playbook still needs analysis but is not blocking. Copy-craft sources still recommended for v2. **Updated 2026-06-11:** Priestley KPI playbook analysis produced at `../analyses/2026-06-11_daniel-priestley_million-dollar-playbook_analysis.md`; no analysis gaps remain in this combo.
