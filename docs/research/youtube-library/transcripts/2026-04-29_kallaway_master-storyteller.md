...
tags:
    ...
    - social media growth
    - best social media growth strategy
    - content marketing
    - marketing tips
    - short-form video
...
timestamps:
    - time: '0:00'
      label: 'Intro'
    - time: '0:24'
      label: 'The Dance (Inspired by SouthPark)'
    - time: '3:27'
      label: 'Rhythm (Inspired by Gary Provost)'
    - time: '5:20'
      label: 'Tone (Inspired by Steve Jobs, Casey Neistat, Emma Chamberlain)'
    - time: '6:57'
      label: 'Direction (Inspired by Christopher Nolan)'
    - time: '8:05'
      label: 'Storylenses (Inspired Taylor Swift)'
    - time: '9:17'
      label: 'The Hook (Inspired by Epic Gardening)'
    - time: '10:49'
      label: 'Outro'
description: |
    Get my free guide on how to build a winning content system (1B+ views, 1M+ followers): https://shortformsystem.co 
    Use Sandcastles to grow 10x faster on social media (try free): https://sandcastles.ai
    Work with me: https://shortform.academy

    In this video, I walkthrough my 6 favorite storytelling techniques to make better performing content.

    Each is inspired by a famous storyteller and explained using a practical example.

    If you're interested in learning how to level up your own short-form content, I made a free community with video lessons like this one. Here's a free invite link: https://skool.com/wavyworld

    Video Time Stamps:
    0:00 Intro
    0:24 The Dance (Inspired by SouthPark)
    3:27 Rhythm (Inspired by Gary Provost)
    5:20 Tone (Inspired by Steve Jobs, Casey Neistat, Emma Chamberlain)
    6:57 Direction (Inspired by Christopher Nolan)
    8:05 Storylenses (Inspired Taylor Swift)
    9:17 The Hook (Inspired by Epic Gardening)
    10:49 Outro

    -------------------------
    SHORT-FORM VIDEO (IG, TIKTOK, LINKEDIN, YOUTUBE, FACEBOOK):
    • Try Sandcastles, my short-form research & storytelling tool that will help you grow 10x faster on social media (free trial): https://sandcastles.ai
    • Take my Short-Form Hooks Masterclass (2 hours long, comes with 37 pages of notes and 400+ hook database) - https://lu.ma/sfa-hooks
    • Hire my short-form video editors - https://forms.gle/TAYRJkV116Q5xois9
    • Join my Short-Form Academy (designed for business owners to build a social media content machine that turns views into leads & sales) - https://shortform.academy

    LONG-FORM VIDEO (YOUTUBE)
    • Get my Complete YouTube System (designed for business owners to build a Youtube content machine that turns views into leads and sales): https://kallaway.co/youtubeblueprint
    • Hire My YouTube Strategist (Ideas, Titles, Thumbnails) - https://forms.gle/5SRPsikwE3RR21Ep8
    • Hire My Thumbnail Designer - https://forms.gle/GJp2XmUmVM9dxZzYA
    • Hire My YouTube Video Editors - https://forms.gle/TAYRJkV116Q5xois9

    ----------
    Follow me (1M+ followers)

    For Content/Marketing Strategy:
    • Instagram: https://www.instagram.com/kallawaymarketing
    • TikTok: https://tiktok.com/@kallawaymarketing
    • YouTube: https://www.youtube.com/@kallawaymarketing
    • LinkedIn: https://www.linkedin.com/in/kanekallaway
    • X: https://www.x.com/kanekallaway
    • Threads: https://www.threads.net/kallaway

    For Tech & AI:
    • Instagram: https://instagram.com/kallaway
    • YouTube: https://youtube.com/@kallawaytech
    • TikTok: https://tiktok.com/@kanekallaway
...
path: docs/research/youtube-library/transcripts/2026-04-29_kallaway_master-storyteller.md
---
...
- **Video**: [Watch on YouTube](https://www.youtube.com/watch?v=t5Z-Q1bg1tU)
- **Duration**: 11:14
- **Upload Date**: 2024-11-04
- **Views**: 2,361,473
- **Analysis**: `docs/research/youtube-library/analyses/2026-04-29_kallaway_master-storyteller_analysis.md`
