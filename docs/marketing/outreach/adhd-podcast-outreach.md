...
# ADHD Podcast Outreach List

> **Goal:** Secure 3-5 podcast appearances in Q1 2026 to reach ADHD audience
> **Pitch Angle:** "Marine turned founder builds AI productivity tool specifically for ADHD minds"
...
**Platform:** YouTube (1M+ subs) + Podcast
**Twitter:** [@HowtoADHD](https://x.com/HowtoADHD)
**Audience:** ADHD education seekers, newly diagnosed adults
...
**Platform:** Podcast (300+ episodes)
**Website:** adhdrewired.com
**Audience:** ADHD adults, professionals, entrepreneurs
...
**Platform:** Podcast
**Website:** hackingyouradhd.com
**Audience:** ADHD productivity seekers
...
**Platform:** Podcast
**Audience:** ADHD coaches, parents, professionals
**Size:** Established
...
**Platform:** Podcast
**Audience:** Women with ADHD, professionals
...
### 6. I Have ADHD Podcast (Kristen Carder)

**Platform:** Podcast
**Audience:** ADHD adults, self-improvement
**Size:** Established
...
### 7. The ADHD Podcast (Pete Wright & Nikki Kinzer)

**Platform:** Podcast (long-running)
**Website:** takecontroladhd.com
**Audience:** General ADHD community
...
### 8. ADHD Nerds (Jesse J. Anderson)

**Platform:** Podcast
**Audience:** ADHD + nerdy/tech interests
**Size:** Growing
...
### 9. Faster Than Normal (Peter Shankman)

**Platform:** Podcast
**Audience:** ADHD entrepreneurs, high performers
**Size:** Established
...
### 10. Succeeding with ADHD (Various)

**Platform:** Multiple small podcasts
**Audience:** Varies
...
> Hi [Name],
>
> I'm DJ, founder of BuildOS - an AI-powered productivity tool I built specifically because traditional tools kept failing my ADHD brain.
>
> Quick background: I served in the Marines (external structure = I thrived), then became an engineer at a $100M startup building complex systems. But I couldn't keep my personal life organized. Every productivity tool I tried worked for 3 days then joined my graveyard of abandoned apps.
>
> So I built BuildOS with a different philosophy: AI maintains the structure FOR you. You just dump your scattered thoughts, and the AI organizes them into projects and next steps. No complex setup. No shame when you abandon it for a week.
>
...
>
> Happy to tailor the conversation to what resonates with your listeners.
>
> DJ Wayne
> BuildOS.app

### Follow-Up Topics to Offer

1. "The ADHD productivity tool graveyard - why we keep failing"
2. "Context Engineering: Making AI actually useful for ADHD"
3. "Building systems vs. maintaining systems (the ADHD difference)"
4. "From Marine structure to founder chaos - my ADHD journey"
5. "Why AI might be the external brain ADHD has been waiting for"

---

## Pre-Outreach Checklist

Before contacting any podcast:

- [ ] Listen to 2-3 recent episodes
- [ ] Follow on Twitter and engage genuinely for 1-2 weeks
- [ ] Note specific episodes or topics to reference
- [ ] Customize pitch to their style/audience
- [ ] Have "Why I Built BuildOS" story polished
...
- [ ] Share episode on Twitter, tag host
- [ ] Send thank you note to host
- [ ] Add episode to press kit
- [ ] Track any signup/traffic spike
- [ ] Request testimonial if went well
...
- **[Why I Built BuildOS](/docs/marketing/content/drafts/why-i-built-buildos.md)** - Story draft for podcast prep
- **[ADHD Strategy](/docs/marketing/strategy/adhd-productivity-os-strategy.md)** - Full market positioning
- **[ADHD Profiles](/docs/marketing/social-media/twitter-profiles/adhd-neurodivergent/)** - Key ADHD accounts
