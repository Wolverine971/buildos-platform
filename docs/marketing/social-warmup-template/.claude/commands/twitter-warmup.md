...
You are conducting a daily Twitter/X engagement scan for @{{YOUR_TWITTER_HANDLE}} to find high-quality reply opportunities that align with the {{YOUR_BRAND}} brand.

## Output

Create a daily engagement doc at:
`docs/social-media/daily-engagement/YYYY-MM-DD_twitter-warmup.md`
...
- `/docs/social-media/profiles/INDEX.md` - Master list of all tracked accounts
- `/docs/social-media/FOUNDER_CONTEXT.md` - Personal brand and voice context
<!-- Add your strategy docs here -->
...
<!-- FILL IN: Your direct competitors -->
| Account | Product | Why Monitor | Strategy |
|---------|---------|-------------|----------|
| @competitor1 | [Their product] | [Why they matter] | [How to engage] |
| @competitor2 | [Their product] | [Why they matter] | [How to engage] |

### Space Leaders (Own Your Terms)

<!-- FILL IN: Key thought leaders in your space whose terms/concepts you want to be associated with -->
| Account | Relevance | Why Monitor | Strategy |
|---------|-----------|-------------|----------|
| @leader1 | [Their concept/term] | [Why important] | [Engagement strategy] |

### What to Look For

**When scanning competitors:**
1. **New features announced** - Can you implement better?
2. **User complaints** - Pain points you can solve
...
**When scanning space leaders:**
1. **New definitions/frameworks** - Incorporate into your narrative
...
2. **Voice Reference** (platform-specific):
   - `docs/social-media/twitter-voice-quick-ref.md`

3. **Engagement Targets** (accounts to scan):
   - `docs/social-media/twitter-engagement-targets.md`

4. **Search Queries** (for topic searches):
   - `docs/social-media/twitter-advanced-search-queries.md`

5. **Profile Database** (detailed account info):
   - `docs/social-media/profiles/INDEX.md`

### Check for Duplicates

Scan the last 7 days of engagement docs to avoid suggesting posts already seen:
- `docs/social-media/daily-engagement/` (all files from last 7 days)
...
<!-- FILL IN from your engagement-targets.md -->

**Round 2: Tier 2 Accounts (Your Niche)**
...
**Round 4: Following Feed Discovery (New Accounts)**
...
- People you follow who are actively discussing your topics
...
| Brand Fit | 3x | How aligned with your messaging |
...
For each selected tweet, create 2-3 reply options following the founder's voice:
...
3. **Use specific experience when relevant** - From the Founder Context document
4. **Product angle** - When relevant, frame around your core thesis IF natural
5. **Be direct** - Cut filler words, lowercase casual
6. **Teammate energy** - We're in this together
7. **Product mentions** - Only when genuinely relevant, use "shameless plug" framing
8. **It's okay to just encourage** - Not every reply needs to teach something

### Reply Templates by Topic

<!-- These will be filled based on your content pillars from FOUNDER_CONTEXT.md -->

**Niche Topic Posts - Value Mode:**
```
[observation from your experience]

[your specific experience relevant to this]

[question to extend the conversation]
```

**Niche Topic Posts - Cheerleader Mode:**
```
...
|---------|-----------|-------|----------------|-----|
| @handle | Xk | [Theme] | [1/2/3] | [brief reason] |
...
Update a profile doc (`/docs/social-media/profiles/[category]/[handle].md`) when you notice:
...
<!-- FILL IN: Your competitors and key accounts -->
1. **Competitors:** @competitor1, @competitor2
2. **Space Leaders:** @leader1, @leader2
...
<!-- FILL IN: Alerts specific to your space -->
1. **Competitor announces feature** that overlaps with your product
2. **Key thought leader posts viral thread** about your topic - engage within hours
3. **Large account mentions** your problem space

**Action for Strategic Alerts:**
1. Note in daily engagement doc with HIGH PRIORITY flag
2. Draft engagement options immediately
3. Consider whether this warrants a content response
...
| File | Update If... |
|------|--------------|
| `profiles/INDEX.md` | New accounts added or follower counts significantly changed |
| `twitter-engagement-targets.md` | New accounts should be added to engagement tiers |
| Your strategy docs | Landscape changes |

---

*Last Updated: {{DATE}}*
*Profile Database: `/docs/social-media/profiles/INDEX.md`*
