<!-- docs/marketing/campaigns/retargeting/STRATEGY.md -->
...
- Retargeting pilot runbook: `/docs/marketing/campaigns/retargeting/RUNBOOK.md`
- Retargeting pilot email copy: `/docs/marketing/campaigns/retargeting/EMAIL_COPY.md`
