...
In an AI world where anyone can ship working software fast, **design, craft, and taste become the moat**. The advantage is no longer "we have software"; it's "our software is excellent and excellently judged." Speed without judgment produces mediocrity at scale. Speed plus taste compounds.

Three big arguments Dylan makes:

1. **Craft is the new differentiator.** Models lower the floor of "shipping working code"; that raises the value of taste, judgment, and design. Excellence wins; "good enough" is mediocre.
2. **Roles are merging into "product builder."** PMs, designers, engineers, and researchers all dip into each other's work. Generalist instinct + deep craft in one area = future-proof.
3. **Hiring is going up, not down.** AI productivity gains are mild-to-moderate in mature codebases. Demand for software is increasing faster than productivity gains (Jevons paradox). Don't plan as if AI cuts headcount — plan as if it expands ambition.

---

## Tips & Tricks (organized by domain)

### A. Leading Through a Crisis or Reset (Adobe deal fallout playbook)

1. **Communicate on a tightening cadence.** Quarterly check-ins → every few weeks → frequent updates as the situation narrows. Don't disappear; cadence signals control.
2. **Be willing to say "the path is narrowing"** even when some employees still believe the deal closes. Truth-telling beats hopium.
3. **Run a "fork in the road" program after the reset.** Figma's "Detach" gave anyone 3 months severance + the right to reapply in 6 months — no judgment. ~4% took it. Many used it for career changes (sales → politics, etc.). Dylan frames this as honest — "you joined Adobe and got Figma, that's a real change."
4. **Pair the off-ramp with a re-commit.** Detach was inseparable from "here's the pace, here's the opportunity, if you're in, let's go." The opt-out makes the opt-in real.
5. **"Keep your foot on the gas pedal."** Use enforced uncertainty as cover to ship hard (Figma launched Dev Mode coming out of the regulatory window).

### B. Maintaining Startup Pace at 13+ Years

6. **Select problems carefully — half the speed game is what you choose to work on.**
7. **Move on if things drag.** If a project isn't converging, kill it or reassign people; don't let timeline-creep become culture.
8. **Audit timeline padding from curiosity, not suspicion.** Ask "is this really going to take that long, and if so, why?" — you'll either learn a real constraint or expose under-staffing.
9. **Keep the org flatter.** Layers slow decisions and dilute clarity.
10. **Watch for path dependency.** People assume something is required when it isn't — or skip something that genuinely is. Question both directions.
11. **Match people to projects they're fired up about.** "Sounds obvious, but people don't always do it." Motivated people outperform skill mismatches.
12. **Maintain the tech-debt vs. new-work balance.** Tech debt becomes a hidden speed cap; ignoring it eventually halts the company.

### C. Becoming a Better Leader (Dylan's own progression)

13. **Master "unpacking context."** Get what's in your head out into a form a group can act on. This is the skill Dylan keeps re-learning.
14. **Show up signaling shared goal.** Even when you're in intense Q&A mode, frame questions as "trying to understand," not "trying to corner."
15. **Hire people who make you better, not people you mentor** (Ben Horowitz). Many of Dylan's best leaders started as mentees and ended up teaching him.
16. **Default to two-way mentorship.** Never assume you're "the mentor." Junior PMs (e.g., Mihika Kapoor) brought him different mental models that improved his thinking.
17. **Drive clarity, not positivity.** Don't shy from hard questions. Push until the team knows the trade-offs even if they don't agree on the choice.
...
### H. AI Product Building (lessons from "Make Design")

39. **Don't ship AI features with mis-naming.** Figma's "Make Design" should have stayed "First Draft." The name implied finality; the feature was a starting point. Naming sets user expectations more than any onboarding.
40. **QA AI surface areas like an adversary, not a user.** Figma's pull happened because typing "make me a weather app" produced something close to Apple's Weather. With a wide-surface tool, you must probe edge cases before launch.
41. **If quality fails, pull it.** Dylan pulled Make Design publicly and explicitly said "would do the same again." Owning a pull is faster than defending a flawed launch.
42. **Don't ship AI on vibes alone.** Build real evals. Vibes "get you somewhere, but it's not rigorous."
43. **Help users start with their design system, not a generic AI aesthetic.** "Ideas die on the vine because the visual expression doesn't match expectations." Consistency lets ideas be evaluated on merit.
44. **Ground AI tools in interop and an ecosystem.** Make + MCP + Figma Design round-trip beats any single-surface AI app. The platform is the moat, not the model.

### I. The Future of Product Development (Dylan's 5-year view)

45. **Roles will merge into "product builder."** Per Figma's own research:
    - 72% say AI tools (e.g., Make) drive expansion of roles/responsibilities.
    - 56% of non-designers engage "a great deal" in design-centric tasks (up 12 pts year-over-year).
    - 53% say even with AI you still need deep knowledge to do a task well.
46. **Specialize deeply, but generalize wider.** "We're all product builders; some of us are specialized in our particular area."
47. **Don't plan headcount as if AI replaces engineers.** In mature codebases, productivity gains are mild-to-moderate. Figma is hiring across the board.
48. **Frame AI as growth, not cost-cutting.** "You can see AI as an opportunity to grow and do more, or as efficiency. Growth is way more exciting." Same advice applies to individuals.
49. **Job-displacement fear is overrated for now.** Only 17% of designers in Figma's survey saw AI as a threat. Jobs change before they disappear.
...
### K. Hiring Bar (what Figma is recruiting for)
...
## What This Means for BuildOS (optional read)
...
- **Possibility-space prompting (tip 51)** is a directly usable pattern for product/design brainstorming inside BuildOS itself — and could become a template inside the product.
...
Full transcript: [`2026-04-28-dylan-field-figma-ceo-design-craft-moat.md`](./2026-04-28-dylan-field-figma-ceo-design-craft-moat.md) (91K chars, 2,281 segments).
