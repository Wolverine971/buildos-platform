---
title: 'ANALYSIS — The $1 Million Landing Page (Daniel Priestley)'
source_video: 'https://www.youtube.com/watch?v=az1Zh-FNSno'
source_transcript: '2025-10-11-daniel-priestley-1m-landing-page.md'
channel: Daniel Priestley
upload_date: 2025-10-11
duration: '12:02'
views: 338913
analyzed_date: '2026-04-27'
topic: lead generation, scorecard marketing, online assessments, landing pages
path: docs/marketing/growth/research/youtube-transcripts/2025-10-11-daniel-priestley-1m-landing-page-ANALYSIS.md
---
...
Then send traffic to the landing page (paid + organic).

---

## Part 1 — The Landing Page (Section by Section)

The landing page has **5 sections, in this exact order**:

### 1. The Hook (top of page)
...
### 2. The Subheading (under the hook)
...
After a strong hook + value prop, the visitor's brain says "this sounds too good to be true." Pre-empt that:
...
Daniel's CTA formula stacks 4 things together:
...
- **Fitness example:** Do you track calories? Do you work out 3–4x/week?

These answers feed the score on the results page.

### Bucket 3: The "Big 5" Qualifying Questions (this is where the sales gold lives)
...
- List of outcomes; pick the most important
...
- Free-text field
- People volunteer wild gold here:
    - "I've already read your book and want to get started"
    - "I have a budget but have to spend it by end of month"
- Why it works: by Q15, they've invested 14 questions of effort — they're primed to spill
...
1. **The Big Reveal** — the overall score
    - Speedometer (75/100)
    - Thermometer (cold / warm / hot)
    - Or any visual metaphor
...
3. **Next Steps** — and this is where the segmentation pays off:
...
### What you get on the back end

The dashboard shows you, per lead:
...
Translation: you're not just collecting emails — you're collecting a **qualified, segmented sales pipeline** with intent data baked in.

---

## The Tips & Tricks (Distilled)

### Strategic

- **Sell the assessment, not the product.** The whole landing page is for _one click_ — start the quiz.
- **Give first.** The quiz delivers value (insights + recommendations) before any sales conversation.
- **Score-then-segment is more powerful than capture-then-blast.** You earn the right to make a tailored offer.
...
### What makes results "dynamic" (and why it matters)

- The page rewrites itself per respondent → feels personal → conversion to next step jumps.
- Different next steps for different lead grades = no sales-team time wasted on wrong-fit leads, and no high-intent leads sent to a generic newsletter.

---

## Suggested Application for 9takes

A few obvious places this maps onto:

1. **Enneagram-typing quiz as the front door** — already on-brand. The current `/enneagram-test` could be reframed using Priestley's structure: Hook (frustration: "Frustrated that personality tests describe you but don't _help_ you?") → 15 questions → Dynamic Results that route to coaching waitlist / community / specific blog by type.
2. **Coaching waitlist (`/book-session`)** — replace static signup with a "Are you ready for 1-on-1 Enneagram coaching?" assessment. The Big 5 qualifying questions (especially budget-implying Q4) would pre-qualify leads before DJ ever talks to them.
3. **Personality-analysis pages** — each celebrity page could end with a mini-assessment ("How similar are _you_ to [celebrity]?") that segments readers into community / quiz / coaching paths.

The "preferred solution" question (Q4) is the highest-leverage adaptation — right now 9takes has no built-in budget signal on lead capture.

---

## Tools mentioned

- **ScoreApp** (scoreapp.com) — Daniel's own tool, 150 templates, claims 10–30 min setup
- **Companion video on traffic** — referenced but not detailed (covers paid + organic to the landing page)
