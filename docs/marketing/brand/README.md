<!-- docs/marketing/brand/README.md -->

# Brand Documentation Hub

> **Start Here:** [BuildOS Marketing Strategy 2026](../strategy/buildos-marketing-strategy-2026.md) for strategy and [BuildOS Brand Guide](./brand-guide-1-pager.md) for day-to-day messaging.
...
### Related Narrative And Lifecycle Docs

| Document                                                                | Purpose                          | When to Use                                            |
| ----------------------------------------------------------------------- | -------------------------------- | ------------------------------------------------------ |
| [**BuildOS Welcome Sequence**](../strategy/buildos-welcome-sequence.md) | Welcome and activation messaging | Onboarding emails, signup lifecycle copy               |
| [**Why I Built BuildOS**](../content/drafts/why-i-built-buildos.md)     | Founder-story draft              | Narrative consistency, podcast prep, founder messaging |
...
4. Use [Why I Built BuildOS](../content/drafts/why-i-built-buildos.md) when you need longer-form founder narrative

---

## Related Documentation

- [Marketing Index](../INDEX.md)
- [Customer Language Analysis](../customer-lingo-adhd.md)
