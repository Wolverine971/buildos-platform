<!-- docs/marketing/visual-assets/renders/author-workflow-teardown/HANDOFF.md -->
...
> Output dir: `docs/marketing/visual-assets/renders/author-workflow-teardown/`
...
| --- | ----------------------------------- | ---------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2   | "Not the only thing you're holding" | Inkprint pain-list card                  | ✅ **Built (first pass)**                                                 | [`asset2-painlist-light.png`](./asset2-painlist-light.png) (2160×2700, 4:5) · src [`asset2-painlist-light.html`](./asset2-painlist-light.html)                                                                  |
| 1   | The mess → the revision plan (HERO) | Before/after real screenshots            | ✅ **Built (first pass)**                                                 | **4:5** [`asset1-beforeafter-light.png`](./asset1-beforeafter-light.png) (2160×2700) · **1:1** [`asset1-beforeafter-square.png`](./asset1-beforeafter-square.png) (2160×2160). Src + raws linked in §1.1 below. |
...
- [`asset1-beforeafter-light.png`](./asset1-beforeafter-light.png) — 4:5 (2160×2700), stacked before→after · src [`asset1-beforeafter-light.html`](./asset1-beforeafter-light.html)
- [`asset1-beforeafter-square.png`](./asset1-beforeafter-square.png) — 1:1 (2160×2160), after-dominant + before inset · src [`asset1-beforeafter-square.html`](./asset1-beforeafter-square.html)

**Asset 1 — real product raws** (live BuildOS, captured via agent-browser)

- [`asset1-before-full.png`](./asset1-before-full.png) — full "New project flow" modal with the §4 text typed in (the BEFORE receipt)
- [`asset1-before-crop.png`](./asset1-before-crop.png) — tight crop of just the input box (used in both composites)
- [`asset1-after-viewport.png`](./asset1-after-viewport.png) — project page, one viewport (header + next-move + first tasks); used in the 4:5
- [`asset1-after-fullpage.png`](./asset1-after-fullpage.png) — full project page (header → kanban → docs); used in the 1:1

**Asset 2** — [`asset2-painlist-light.png`](./asset2-painlist-light.png) · src [`asset2-painlist-light.html`](./asset2-painlist-light.html)
