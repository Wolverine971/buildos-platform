...
## Strategy: Peer-Level Engagement

Unlike Twitter/LinkedIn where you engage with big accounts to get visibility, Instagram rewards **community engagement with peers**. Accounts in your follower range (or 2-5x your size) are more likely to:

1. **Engage back** - Creating mutual engagement loops
2. **Notice you** - Smaller accounts pay attention to every comment
3. **Build real relationships** - DM conversations, collaborations, shoutouts
4. **Have overlapping audiences** - Their followers are your potential followers
...
## Peer Account Discovery Criteria

When scanning Instagram, flag accounts for potential addition to tiers if they:
...
- **Comments**: Max 15-20 per hour, space 5+ minutes apart
- **Likes**: Max 50-60 per hour
- **Follows**: Max 20-30 per hour
- **Story views**: No known limit but don't speed-run through them
- **DMs**: Be cautious, Instagram flags mass DMs quickly
