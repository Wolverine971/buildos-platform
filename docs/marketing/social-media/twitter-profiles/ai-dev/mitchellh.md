...
> **HashiCorp Founder - Infrastructure Legend**
...
- Insights on building developer tools at scale

## Background

- Founded HashiCorp (IPO'd 2021)
- Created Vagrant, co-created Terraform
- Known for exceptional developer experience design
- Recent focus on AI quality and tooling
...
- Building sustainable developer tools
...
- Mitchell values substance over hype
- Don't fanboy - engage intellectually
- His AI takes are informed by decades of dev tools
- Rare combination of credibility and AI interest
