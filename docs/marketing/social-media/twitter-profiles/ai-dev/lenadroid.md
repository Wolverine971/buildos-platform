...
> **DevRel @ Akamai - Context Engineering Educator**
...
- Bridge between enterprise and developer community
...
- Educational approach aligns well with BuildOS mission
- Good model for explaining complex AI concepts
- Context engineering is core to BuildOS positioning
- Potential collaboration on educational content
