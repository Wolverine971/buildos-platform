...
> **Svelte Creator - STRATEGIC PRIORITY**
...
- Connection to Vercel ecosystem

## Background

- Former journalist at The Guardian (data viz)
- Created Rollup.js bundler
- Created Svelte framework
...
- Svelte releases and updates
- Framework design philosophy
- Frontend performance and DX
...
- Rich values substance over enthusiasm
- Technical credibility matters
- He's opinionated but open to good arguments
- Don't be tribal about frameworks
