...
Companion to [the architecture assessment](/Users/djwayne/buildos-platform/apps/worker/src/workers/agentic-chat/djflow-review.md)
and [DJ's original notes](/Users/djwayne/buildos-platform/apps/worker/src/workers/agentic-chat/djflow.md).
...
| `apps/worker/src/workers/agentic-chat/executionInput.ts`                            | Load command first; prepare and attach immutable input when pending                                                                         |
