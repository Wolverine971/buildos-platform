...
export function buildMutationBatchReviewRequest(
	...
	const canonicalContract = canonicalizeAgenticChatJson(
		authorization.contract as unknown as JsonValue
	);
	const boundLabels = Object.fromEntries(authorization.labelBindings);
	const fieldSemantics = describeContractValueSemantics(
