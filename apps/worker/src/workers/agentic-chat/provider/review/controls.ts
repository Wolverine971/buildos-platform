...
export const SEMANTIC_COMMISSION_GUIDANCE = Object.freeze([
	...
	'An unstated optional classification such as a task type_key on a create is an implementation default: approve it omitted or plausibly set; revise only a contradiction of a stated one. Reclassifying an entity unasked is uncommissioned.',
