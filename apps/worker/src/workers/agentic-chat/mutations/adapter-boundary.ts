...
export function knownFailure(code: string, message: string): AgenticChatMutationAdapterError {
	return new AgenticChatMutationAdapterError('known_failed', code, message);
}

export function uncertainFailure(code: string, message: string): AgenticChatMutationAdapterError {
