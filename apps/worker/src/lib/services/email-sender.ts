...
<p style="font-size: 14px; color: #2563eb;">
	<a href="${this.baseUrl}/projects?briefDate=${brief.brief_date}" style="color: #2563eb; text-decoration: none;">View in BuildOS</a>
	<span style="color: #9ca3af;"> • </span>
	<a href="${this.baseUrl}/settings" style="color: #2563eb; text-decoration: none;">Manage Email Preferences</a>
</p>
`.trim();
