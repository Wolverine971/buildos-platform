...
async function runCleanupMigration() {
  ...
  console.log(
    `   Daily briefs (failed/pending): ${dailyBriefsFailedCount || 0}`,
  );
  console.log(
    `   Daily briefs (stuck processing): ${dailyBriefsStuckCount || 0}`,
  );
  ...
  console.log(
    `   Remaining old project briefs: ${remainingProjectBriefs || 0}`,
  );
