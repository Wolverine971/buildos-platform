// worker-queue/labelFilePaths.ts
import fs from "fs";
...
const COMMENT_PATTERNS = {
  // HTML-style comments
  svelte: (filePath: string) => `<!-- worker-queue/${filePath} -->`,
  html: (filePath: string) => `<!-- worker-queue/${filePath} -->`,
  xml: (filePath: string) => `<!-- worker-queue/${filePath} -->`,

  // Single-line comments
  ts: (filePath: string) => `// worker-queue/${filePath}`,
  js: (filePath: string) => `// worker-queue/${filePath}`,
  mjs: (filePath: string) => `// worker-queue/${filePath}`,
  jsx: (filePath: string) => `// worker-queue/${filePath}`,
  tsx: (filePath: string) => `// worker-queue/${filePath}`,
  // json: (filePath: string) => `// ${filePath}`,
  jsonc: (filePath: string) => `// worker-queue/${filePath}`,

  // CSS-style comments
  css: (filePath: string) => `/* worker-queue/${filePath} */`,
  scss: (filePath: string) => `/* worker-queue/${filePath} */`,
  sass: (filePath: string) => `/* worker-queue/${filePath} */`,
  less: (filePath: string) => `/* worker-queue/${filePath} */`,

  // Python
  py: (filePath: string) => `# worker-queue/${filePath}`,

  // Shell scripts
  sh: (filePath: string) => `# worker-queue/${filePath}`,
  bash: (filePath: string) => `# worker-queue/${filePath}`,

  // SQL
  sql: (filePath: string) => `-- worker-queue/${filePath}`,

  // YAML
  yml: (filePath: string) => `# worker-queue/${filePath}`,
  yaml: (filePath: string) => `# worker-queue/${filePath}`,
};
...
function addOrUpdatePathComment(filePath: string, rootDir: string): boolean {
  try {
    ...
    const commentFunction =
      COMMENT_PATTERNS[ext as keyof typeof COMMENT_PATTERNS];
...
function main() {
  ...
  console.log(
    ...
    Object.keys(COMMENT_PATTERNS).join(", "),
  );
  console.log("");
