...
//
// Re-export shim. Implementation moved to @buildos/shared-agent-ops (src/ontology/edge-relationship-resolver.ts)
...
export * from '@buildos/shared-agent-ops/ontology/edge-relationship-resolver';
