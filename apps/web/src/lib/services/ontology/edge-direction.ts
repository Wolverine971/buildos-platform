...
//
// Re-export shim. Implementation moved to @buildos/shared-agent-ops (src/ontology/edge-direction.ts)
...
export * from '@buildos/shared-agent-ops/ontology/edge-direction';
