...
7. Return the output contract. If nothing reaches Level 3 for strategic/single-target outreach, refuse and report what was searched (see Guardrails).
