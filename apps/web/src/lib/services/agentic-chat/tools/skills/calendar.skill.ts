...
import googleCalendarMarkdown from './definitions/google_calendar/SKILL.md?raw';
...
export const googleCalendarSkill = defineMarkdownSkill({
	id: 'google_calendar',
	markdown: googleCalendarMarkdown
});
