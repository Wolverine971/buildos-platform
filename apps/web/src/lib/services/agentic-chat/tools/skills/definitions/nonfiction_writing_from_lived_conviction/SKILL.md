...
legacy_paths:
    ...
    - docs/research/youtube-library/skill-drafts/nonfiction-writing-from-lived-conviction/SKILL.md
path: apps/web/src/lib/services/agentic-chat/tools/skills/definitions/nonfiction_writing_from_lived_conviction/SKILL.md
---
...
- A draft reads generic or AI-flavored and needs a real speaker behind it
