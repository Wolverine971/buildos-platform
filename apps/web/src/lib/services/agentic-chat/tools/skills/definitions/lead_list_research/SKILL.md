...
legacy_paths:
    ...
    - lead_list_research_with_claude_code
    - docs/research/youtube-library/skill-drafts/lead-list-research-with-claude-code/SKILL.md
path: apps/web/src/lib/services/agentic-chat/tools/skills/definitions/lead_list_research/SKILL.md
---
...
- Do not hide noise — report failure patterns alongside the clean rows.
- Do not tighten more than one ICP variable at a time, or you cannot tell which rule fixed the list.
- Do not invent contacts or enrichment data; mark gaps as gaps.
