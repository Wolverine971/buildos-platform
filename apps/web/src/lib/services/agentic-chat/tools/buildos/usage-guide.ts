...
const USAGE_SECTIONS: BuildosDocSection[] = [
	...
	},
	{
		...
		summary:
			'Help users select the appropriate chat mode based on what they want to accomplish—global brainstorming, project work, or focused entity deep-dives.',
		highlights: [
	...
	},
	{
		...
		highlights: [
			...
			'Tool groups cover list/search/detail/action operations. For discovery, prefer `search_all_projects` across projects and `search_project` inside one project before loading details.',
