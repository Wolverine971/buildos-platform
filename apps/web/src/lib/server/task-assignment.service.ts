...
import { notifyTaskAssignmentAdded as notifyTaskAssignmentAddedShared } from '@buildos/shared-agent-ops/ops/task-assignment-notification.service';
...
export async function notifyTaskAssignmentAdded({
	...
	return notifyTaskAssignmentAddedShared({
		supabase,
		notificationSupabase: createAdminSupabaseClient(),
		projectId,
		projectName,
		taskId,
		taskTitle,
