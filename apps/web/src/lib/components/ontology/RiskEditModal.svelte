...
<Modal
	...
	ariaLabel={title || risk?.title || 'Risk'}
	customClasses="wt-plate"
>
	{#snippet header()}
		<EntityModalHeader
			title={title || risk?.title || 'Risk'}
			icon={headerIcon}
