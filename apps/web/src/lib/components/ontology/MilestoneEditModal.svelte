...
<Modal
	...
	ariaLabel={title || milestone?.title || 'Milestone'}
	customClasses="wt-plate"
>
	{#snippet header()}
		<EntityModalHeader
			title={title || milestone?.title || 'Milestone'}
			icon={headerIcon}
		...
		<div class="px-2 py-2 sm:px-4 sm:py-4">
			...
			{:else}
				...
				>
					...
					<EntityModalDetailsDrawer panelLabel="Milestone details">
							...
							<CardBody padding="none">
								<div class="divide-y divide-border/70">
									...
									>
										<div class="flex items-center gap-2">
											<Calendar class="h-4 w-4 text-muted-foreground" />
											<p class="micro-label font-semibold">Due Date</p>
										</div>
