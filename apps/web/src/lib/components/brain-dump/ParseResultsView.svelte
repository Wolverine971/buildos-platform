	...
	{#snippet children()}
		...
		{#if parseResults.summary || hasErrors}
			<div class="mb-6">
				{#if parseResults.summary}
					<div class="clarity-zone rounded p-4 mb-4">
				...
				{#if hasErrors}
					<div
						class="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded p-4"
					>
						<div class="flex items-start gap-3">
							...
							<div class="flex-1">
								...
								<p class="text-sm text-amber-700 dark:text-amber-300 mb-3">
									{operationsWithErrors.length} of {parseResults.operations
										.length} operations have validation errors.
		...
		<div class="space-y-2 sm:space-y-3 px-4 sm:px-6 py-4">
			{#each parseResults.operations as operation (operation.id)}
				...
				<div
					class="border rounded p-3 sm:p-4 transition-all duration-200
					{hasError
						? 'border-red-300 dark:border-red-700 bg-red-50 dark:bg-red-900/10'
						: isDisabled
							? 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 opacity-60'
							: 'clarity-zone hover:border-gray-300 dark:hover:border-gray-600'}"
				>
					<div class="flex items-start gap-3">
						<!-- Content -->
						<div class="flex-1">
