	...
	>
		<div class="flex items-center gap-2">
			...
			<div class="min-w-0 flex-1">
				<h3 class="text-xs font-semibold text-foreground sm:text-sm">Available Slots</h3>
	...
	{#if config.enabled}
		<div class="space-y-3 px-3 py-3 sm:px-4 sm:py-4">
			...
			<div class="space-y-1.5">
				<p class="block text-xs font-semibold text-foreground">Buffer Time</p>
			...
			<!-- Slot Duration -->
			<div class="space-y-1.5">
				<p class="block text-xs font-semibold text-foreground">Slot Duration</p>
				<div class="flex items-center justify-between text-xs text-muted-foreground">
					<span
						>Min: <strong class="text-foreground"
							>{formatDuration(localMinDuration)}</strong
						></span
					>
					<span
						>Max: <strong class="text-foreground"
				...
				<div class="space-y-1.5">
					<!-- Min Duration Slider -->
					<div class="flex items-center gap-2">
						<span class="text-xs text-muted-foreground w-10">Min:</span>
						<input
							type="range"
							min="15"
							max="600"
					...
					<!-- Max Duration Slider -->
					<div class="flex items-center gap-2">
						<span class="text-xs text-muted-foreground w-10">Max:</span>
						<input
							type="range"
							min="30"
							max="600"
			...
			<!-- Time Window -->
			<div class="space-y-1.5">
				<p class="block text-xs font-semibold text-foreground">Time Window</p>
				<div class="flex items-center justify-between text-xs text-muted-foreground">
					<span
						>Earliest: <strong class="text-foreground"
							>{formatHour(localEarliestStart)}</strong
						></span
					>
					<span
						>Latest: <strong class="text-foreground"
				...
				<div class="space-y-1.5">
					...
					<div class="flex items-center gap-2">
						<span class="text-xs text-muted-foreground w-14">Earliest:</span>
						<input
							type="range"
							min="0"
							max="23"
					...
					<!-- Latest End Slider -->
					<div class="flex items-center gap-2">
						<span class="text-xs text-muted-foreground w-14">Latest:</span>
						<input
							type="range"
							min="1"
							max="24"
