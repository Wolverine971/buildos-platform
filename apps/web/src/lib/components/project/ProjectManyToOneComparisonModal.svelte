	...
	<div class="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 flex flex-col h-full max-h-[80vh]">
		...
		<div class="flex-1 overflow-auto">
			...
			{:else if !referenceVersion}
				<div class="text-center py-8">
					<p class="text-muted-foreground">No reference version provided.</p>
				</div>
			{:else if comparison}
				<ManyToOneDiffView
					{comparison}
			...
			{:else}
				<div class="text-center py-8">
					...
					></div>
					<p class="text-muted-foreground">Creating comparison...</p>
				</div>
			{/if}
		</div>

		<!-- Actions -->
		<div class="mt-4 flex justify-end pt-4 border-t border-border">
