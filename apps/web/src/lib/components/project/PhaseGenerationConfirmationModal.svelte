									...
									{#if selectedSchedulingMethod === method.value}
										...
										>
											...
											{:else if method.value === 'calendar_optimized'}
												...
												calendar events while respecting phase boundaries.
											{/if}
										</div>
									{/if}
								</div>
							...
							>
								<div class="flex items-start gap-2">
									...
									<p class="text-xs text-blue-700 dark:text-blue-300">
										...
										assigned phases. This ensures better workflow and timeline
										alignment.
									</p>
								</div>
							</div>
							...
							>
								<div class="flex items-start gap-2">
									...
									<p class="text-xs text-amber-700 dark:text-amber-300">
										Tasks will maintain their current dates. This may result in
										less optimal phase organization if task dates conflict with
										phase timelines.
									</p>
								</div>
							</div>
									...
									<div class="flex items-start gap-2">
										...
										<div class="flex-1">
											<p class="text-xs text-amber-700 dark:text-amber-300">
												...
												calendar events and create new ones. This action cannot
												be undone.
											</p>
												...
												>
													<div class="flex items-start gap-2">
														...
														>
															...
															adjusting review cycles to align with
															phase completions. You'll review all
				...
				<div class="mb-6 p-4 bg-muted rounded-lg">
					...
					<div class="space-y-1 text-sm text-muted-foreground">
						...
						{#if previewData.estimated_phases}
							<p>
								Estimated <strong>{previewData.estimated_phases}</strong> phases will
								be created
							</p>
						{/if}
					</div>
