		...
		>
			<div class="flex items-start gap-2">
				...
				<p class="text-sm text-blue-700 dark:text-blue-300">
					These suggestions aim to align recurring tasks with phase boundaries for better
					workflow. You can accept or reject each suggestion individually.
				</p>
			</div>
		</div>
									...
									<div>
										...
										>
											...
											<div class="text-xs text-gray-500 dark:text-gray-400">
												Starts: {formatDate(suggestion.current_start_date)}
											</div>
											{#if suggestion.current_end_date}
												<div
													class="text-xs text-gray-500 dark:text-gray-400"
												>
													Ends: {formatDate(suggestion.current_end_date)}
												</div>
											{/if}
										</div>
									</div>
