...
>
	...
	<div class="p-4 border-b border-gray-100 dark:border-gray-700">
		<div class="flex items-start justify-between">
			...
			<a
				...
				class="ml-2 p-1.5 text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
				title="Go to project"
			>
		...
		{#if brief.metadata}
			<div class="flex items-center gap-3 mt-2 text-xs text-gray-500 dark:text-gray-400">
				...
				{#if brief.metadata.completion_rate !== undefined}
					<span class="flex items-center">
						<div
							class="w-3 h-3 mr-1 rounded-full bg-gray-200 dark:bg-gray-600 relative overflow-hidden"
						>
							<div
	...
	<div class="p-4 flex-1 flex flex-col">
		...
		<div class="mt-4 flex items-center justify-between">
			<span class="text-xs text-gray-500 dark:text-gray-400"> Click to view full brief </span>
			<div
