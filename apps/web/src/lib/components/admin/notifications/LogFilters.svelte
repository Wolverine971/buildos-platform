			...
			<div class="lg:col-span-2">
				...
				<div class="relative">
					...
					<input
						...
						class="w-full pl-10 pr-3 py-2 border border-border rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:border-ring text-sm"
					/>
				</div>
			</div>
		{/if}
		...
		{#if config.showNamespace}
			<div>
				...
				<input
					...
					class="w-full px-3 py-2 border border-border rounded-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:border-ring text-sm"
				/>
			</div>
		{/if}
