...
// user states the outcome AND the next step in one breath. Two things follow
// from that and both are asserted:
//
...
//      NOWHERE.) The acting model must record it: the worker's deterministic
//      stated-future floor, which matched the user's words with a regex, was
//      retired 2026-09-23 (AGENTS.md "Never classify language with regex").
//
