...
function followUpPromptForProfile(profile: AgentClientProfile): string {
	...
	return [
		...
		'For project work, call get_onto_project_status first when available so you have the current project snapshot, including collaborators, before reading deeper or writing.',
