			...
			<div class="min-w-0 space-y-2 sm:space-y-3">
				...
				>
					<button
						...
						class="relative rounded-md px-3 sm:px-4 py-1.5 sm:py-2 transition pressable {activeView ===
						'details'
	...
	>
		<div class="p-3 space-y-2">
			...
			{#if plans.length > 0}
				...
				>
					<div class="flex items-center gap-2 px-3 py-2 border-b border-border/50">
						<div class="w-6 h-6 rounded-md bg-info/10 flex items-center justify-center">
							<Calendar class="w-3 h-3 text-info" />
						</div>
						<span class="text-xs font-semibold text-foreground">Plans</span>
