<!-- apps/web/src/routes/projects-old/[id]/notes/[noteId]/+page.svelte -->
<script lang="ts">
	import {
		ArrowLeft,
		Settings,
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
	...
	<header
		class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-0"
	>
