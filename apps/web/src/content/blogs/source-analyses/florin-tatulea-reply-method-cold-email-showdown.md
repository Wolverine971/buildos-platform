...
sourceUrl: 'https://www.youtube.com/watch?v=Ag-6pB51s5o'
sourceChannelUrl: 'https://www.youtube.com/@30MPC'
lineagePeople:
    - 'Florin Tatulea'
    - 'Evan Greek'
    - 'Jason Bay'
...
lineageSources:
    - title: 'Cold Email Showdown: Rookie Sales Rep vs 10-Year Director'
      ...
      channelUrl: 'https://www.youtube.com/@30MPC'
      sourceType: 'youtube_video'
      url: 'https://www.youtube.com/watch?v=Ag-6pB51s5o'
relatedSkills:
    - 'cold-email-engagement-first-outreach'
path: apps/web/src/content/blogs/source-analyses/florin-tatulea-reply-method-cold-email-showdown.md
---

# Reply-Method Cold Email: Lessons from Florin Tatulea and 30MPC
...
1. **Packaging.** Subject line plus preview text. Does it look worth opening?
2. **Body.** Personalization, problem, solution, and proof. Does it feel relevant enough to read?
3. **Style.** Formatting, length, tone, and human feel. Does it sound like a person wrote it?
...
1. Gather public context.
2. Summarize triggers and plausible pain.
3. Generate subject/body options.
4. Human-edit for taste, specificity, and truth.
5. Reject anything that sounds like generic AI personalization.
