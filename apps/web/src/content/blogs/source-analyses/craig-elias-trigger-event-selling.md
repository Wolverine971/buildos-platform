---
title: 'Trigger Event Selling: Lessons from Craig Elias'
description: 'A deep read of Craig Elias''s "Shift Selling" framework — the A/B/C trigger taxonomy (Awareness, Bad experience, Change), why prospects need three events to actually buy, the 75% win-rate first-in advantage, and how to systematically monitor for buying moments instead of guessing at timing.'
author: 'DJ Wayne'
date: '2026-05-15'
lastmod: '2026-05-15'
changefreq: 'monthly'
...
readingTime: 8
excerpt: 'Craig Elias literally wrote the book on trigger-event selling. His thesis: prospects do not buy because your email arrives — they buy because something in their world broke. There are three event types (Awareness, Bad experience, Change), buyers need three events stacked to actually transact, and the vendor who arrives first wins 74% of the deals. Cold outreach without trigger thinking is luck.'
sourceTitle: 'Shift Selling: Turn Your Prospects into Customers'
sourceCreator: 'Craig Elias (SHiFT Selling)'
sourceUrl: 'https://www.youtube.com/watch?v=KuRUanwNzSc'
sourceChannelUrl: 'https://www.youtube.com/@Badgermaps'
lineagePeople:
    - 'Craig Elias'
    - 'Steve Benson'
lineageSources:
    - title: 'Shift Selling: Turn Your Prospects into Customers'
      creator: 'Craig Elias'
      creatorType: 'Person'
      creatorUrl: 'https://www.linkedin.com/in/craigelias'
      channelName: 'Badger Maps (Outside Sales Talk)'
      channelUrl: 'https://www.youtube.com/@Badgermaps'
      sourceType: 'youtube_video'
      url: 'https://www.youtube.com/watch?v=KuRUanwNzSc'
    - title: 'SHiFT! Harness the Trigger Events That Turn Prospects into Customers'
      creator: 'Craig Elias and Tibor Shanto'
      creatorType: 'Person'
      sourceType: 'book'
      url: 'https://shiftselling.com/book/friends/'
relatedSkills:
    - 'cold-email-engagement-first-outreach'
    - 'cold-email-icp-signal-design'
path: apps/web/src/content/blogs/source-analyses/craig-elias-trigger-event-selling.md
---
...
The default mode of most cold outreach. _"Hi, I'm calling because we're better, faster, cheaper."_
...
The prospect's current vendor broke their promise. This is the strongest _internal_ trigger because the prospect is already mentally shopping.
...
Elias's favorite category because changes are _predictable_ and _publicly observable_.
...
This is the cleanest hookup from Elias to Brent Adamson: _new hires are statistically more likely to be Mobilizers_, because they have a mandate to change something and a clean record to defend.
...
This is why so many trigger-data tools disappoint. They surface Event 1 (new hire, funding round, exec change) and the rep expects an immediate buying conversation. The right play is to use Event 1 as the _cold outreach entry point_ and then help the prospect _reach_ Event 2 by building the case.
...
The data point Elias keeps citing: when the vendor is _first in_ — before the buyer has finished defining the problem — they win roughly 74–75% of the time. The reason is structural. The first vendor to talk to the buyer shapes the evaluation criteria. Every later vendor is graded against the first vendor's framing.
...
| **The prospect themselves** ("call me in six months")             | They are _telling_ you they are in the window                                       |
...
When a prospect signals they are in the window but pushes scheduling, Elias's pattern is to compress _the time commitment_ until they say yes:
...
- **Win-rate framing.** The 75% number is for the first vendor to _fully reframe the problem_ with the buyer — not the first vendor to send an email. The cold email is the entry point; the reframe happens in the first conversation.
