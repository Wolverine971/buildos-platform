...
ROLE IN THE CLUSTER:
T35 of the WS09 anti-feed/thinking-environment cluster. The felt-experience
opener that names the three feelings (curiosity collapse, feed paranoia,
algorithm-shaped thoughts) the reader has but doesn't have words for. Sets up
"chosen input" as the unit of recovery. Lighter on Devin numbers than
your-morning-without-the-algorithm — that post owns the receipts angle. This
post owns the vocabulary angle.

DELIBERATE CHOICES:
- Hook is felt-experience, not numbers. Different entry point from sibling.
- "Chosen input" carries the post — repeated 5+ times, defined precisely.
- The three feelings get named with one example each, no listicle structure.
- BuildOS section is short and shows the direction of the arrow, not features.
- The practice is something a reader can do without signing up — a 60-second
  audit, no product required.
- Closing line is the cluster's stance distilled: the anti-feed is not an app.

TITLE NOTE:
Sibling post your-morning-without-the-algorithm has the title "You're Not
Choosing What You Think About Anymore" — present tense, broader scope. This
post's title flips to past tense and treats the loss as the topic. Distinct
enough; cross-linked.
