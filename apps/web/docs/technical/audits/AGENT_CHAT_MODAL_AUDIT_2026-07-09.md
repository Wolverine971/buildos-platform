...
**Wave 1 — hot path (biggest user-felt win, ~1 day):**
1.3 prewarm keystroke churn → 1.1 timeline rebuild → 1.2 markdown re-parse → 1.4 dev-only token counter → 1.5 runes hygiene.
