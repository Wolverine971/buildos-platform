...
<script lang="ts">
  ...
  const TaskCreateModal = lazy(() =>
    import('$lib/components/ontology/TaskCreateModal.svelte')
  );

  const GoalCreateModal = lazy(() =>
    import('$lib/components/ontology/GoalCreateModal.svelte')
  );
...
<div class="px-fluid-sm py-fluid-md">
  <h1 class="text-fluid-4xl font-bold mb-fluid-md">
    Heading scales smoothly
  </h1>
  <p class="text-fluid-base leading-relaxed">
    Text that scales proportionally
  </p>
</div>
```
