...
export async function POST(request: Request) {
	...
	const isValid = stripe.webhooks.constructEvent(rawBody, signature, webhookSecret);
}
```
...
async function logWebhookAttempt(eventType: string, success: boolean, error?: string) {
