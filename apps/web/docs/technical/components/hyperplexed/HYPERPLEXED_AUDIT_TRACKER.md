...
| Admin chat user performance          | [`ADMIN_CHAT_USER_PERFORMANCE_AUDIT_2026-07-05.md`](./ADMIN_CHAT_USER_PERFORMANCE_AUDIT_2026-07-05.md) | 2026-07-05 | 🔶 Phase 2 in progress: Phase 1 fixes plus `chat-users` frontend types/helpers, KPI strip, leaderboards, desktop table extraction, mobile card fallback, filter panel/chips, drawer semantics extraction, and redacted timeline extraction. **Open:** remaining page/service split, raw command controls, shared DTOs, page-level UI tests, live visual verify | ⬜ pending                                             |
...
2. **Admin chat user performance extraction** — split `/admin/chat/users` page + backend analytics
   ...
   drawer semantics extraction, and redacted timeline extraction shipped in Phase 2.
