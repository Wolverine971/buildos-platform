...
| Dashboard inbox modal content        | [`DASHBOARD_INBOX_MODAL_AUDIT_2026-07-07.md`](./DASHBOARD_INBOX_MODAL_AUDIT_2026-07-07.md)             | 2026-07-07 | ✅ Tier 1 + Tier 2 + Tier 3 shipped: reduced-motion gates, primitive-equivalent focus/tap treatment, overflow-safe body text/failure rows, lucide wrapper cleanup, `.micro-label` cleanup, title-first item hierarchy, duplicate project-path cleanup, real group `tablist` semantics, separated decision vs. assistive actions, `Later`→`Snooze`, collapsible dismiss feedback, and review-item spotlight focus (P1/P4/P5/P6/P7/P8/P9/P11/P13/P16). **Deferred:** authenticated real-data screenshots.                                                          | ⬜ pending authenticated desktop+iPhone light/dark     |
