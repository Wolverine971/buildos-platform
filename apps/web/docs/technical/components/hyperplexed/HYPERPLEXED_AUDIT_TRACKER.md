...
| Admin chat user performance          | [`ADMIN_CHAT_USER_PERFORMANCE_AUDIT_2026-07-05.md`](./ADMIN_CHAT_USER_PERFORMANCE_AUDIT_2026-07-05.md) | 2026-07-05 | 🔶 Phase 3 started: Phase 1 fixes plus Phase 2 frontend extraction/export helpers/tests, and Phase 3 redaction + query parser modules/tests. **Open:** remaining backend service split, shared DTOs, row-loader/rollup/detail/redacted-session modules, raw command controls, `chat-user-ui` tests, page-level UI tests, live visual verify                                                                                                                                                                                                                      | ⬜ pending                                             |
...
2. **Admin chat user performance extraction** — split `/admin/chat/users` page + backend analytics
   ...
   redaction module extraction/tests, and query parser extraction/tests shipped.
