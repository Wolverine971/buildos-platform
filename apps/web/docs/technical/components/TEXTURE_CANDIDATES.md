...
_Suggestions, drafts, AI recommendations, uncommitted states_
...
_Default UI surfaces, most cards, everyday working state_
...
_Milestones, key decisions, committed items, important content_
...
_Modals, system alerts, canonical views, permanent decisions_
...
_Creation flows, new projects, drafts, onboarding, brain dumps_
...
_Active work views, task lists, in-progress states_
...
_Today focus, deadlines, priority zones, time-sensitive_
...
_Error states, warnings, needs triage, blocked items_
...
_Shared projects, dependency graphs, linked entities_
...
_Primary containers, modals, canonical views, official content_
