...
| Working draft | Planning and draft space before publishing                           | `apps/web/docs/content/BLOG_DRAFT_*.md`; YouTube/source-derived skill drafts can start as `docs/research/youtube-library/skill-drafts/<slug>/SKILL.md` |
...
| Skill                            | Status                           | Notes                                                                                            |
| -------------------------------- | -------------------------------- | ------------------------------------------------------------------------------------------------ |
| Google Calendar for agents       | First public skill guide created | Public article lives under `apps/web/src/content/blogs/agent-skills/`; runtime skill is separate |
...
Claude Code command: use `/youtube-to-skill` when the source is a YouTube URL, transcript file, chat export, or several source files that should become a public agent-skill guide. YouTube sources are indexed in `docs/research/youtube-library/`; source-only intake and staging are documented in `docs/research/youtube-library/INGESTION_FLOW.md`.
