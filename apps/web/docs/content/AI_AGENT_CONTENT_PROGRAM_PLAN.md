...
- [AI_AGENT_SKILL_REPO_PIPELINE.md](./AI_AGENT_SKILL_REPO_PIPELINE.md)
...
| Google Calendar For AI Agents: Search Before You Create | `google-calendar-for-ai-agents-search-before-you-create` | `agent-skills` | Initial skill guide published in content tree | Jab (Technical / Practical)     | Founders, operators, builders, AI agent developers        | Use BuildOS to turn calendar access into durable operational context | 2026-04-27 | [Published guide](/apps/web/src/content/blogs/agent-skills/google-calendar-for-ai-agents-search-before-you-create.md) / [source draft](./BLOG_DRAFT_GOOGLE_CALENDAR_FOR_AI_AGENTS_SEARCH_BEFORE_YOU_CREATE.md) |
...
- review the published `agent-skills` version and decide whether the old docs draft should be kept as source notes or archived
