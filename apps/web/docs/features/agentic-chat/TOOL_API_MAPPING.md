...
The runtime exposes one hybrid direct-tool surface:
...
| Tool surface       | `apps/web/src/lib/services/agentic-chat/tools/core/gateway-surface.ts`          |
| Op registry        | `apps/web/src/lib/services/agentic-chat/tools/registry/tool-registry.ts`        |
