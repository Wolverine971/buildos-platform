...
**Generated at:** 2025-10-07T01:31:42.417Z
...
```json
{
	...
	"timestamp": "2025-10-07T01:31:42.416Z"
}
```
...
**IMPORTANT CONTEXT:**
Current date and time: 2025-10-07T01:31:42.025Z
...
- "next week" → start_date: next Monday (calculate actual date)
   ...
   - Current date context: Today is 2025-10-07
