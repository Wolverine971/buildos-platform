...
tags: [research, timeblocks, daily-briefs, architecture, worker-service, capacity-analysis]
status: complete
...
export interface DailyBriefAnalysisWithTimeBlocks extends DailyBriefAnalysisPromptInput {
...
export function buildDailyBriefUserPromptWithTimeBlocks(
	...
	if (timeAllocationContext.unscheduledTimeAnalysis.totalMinutes > 0) {
		...
		if (timeAllocationContext.unscheduledTimeAnalysis.suggestedTasks.length > 0) {
