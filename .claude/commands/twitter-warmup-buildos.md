...
- `/docs/marketing/social-media/twitter-accounts-tracker.md` - Account tracking
- `/docs/marketing/social-media/twitter-strategy-recommendations-log.md` - Strategy log

**Cross-Reference:**
- `/docs/marketing/social-media/twitter-profiles/INDEX.md` - Profile database

---

## @build_os Voice Summary

### The Vibe: Edgy + Relatable

> BuildOS is the friend who tells you the truth about productivity.
> Not a thought leader. Not corporate. Not trying to fix you.
> We call out the bullshit and celebrate chaos.

### Core Personality

1. **Anti-complex tools** - Drag Notion, Asana, Monday when appropriate
...
## Phase 0: Check @build_os Activity First

### Step 1: Check @build_os Notifications
Navigate to: **https://x.com/build_os/notifications** (or switch to @build_os account)

Look for:
- Replies to @build_os posts (respond to keep conversations going)
- Quote tweets mentioning BuildOS
- Users asking about the product
- DMs (product questions, feedback)

### Step 2: Check @djwayne3 Cross-Promotion Opportunities
Navigate to: **https://x.com/djwayne3**

Look for recent @djwayne3 posts that @build_os could:
- Quote tweet with a product angle
- Reply to with brand voice
- Amplify

**Cross-promote sparingly:** 1-2x per week max.
...
Scan the last 7 days of @build_os engagement docs:
- `docs/marketing/social-media/daily-engagement/*_twitter-warmup-buildos.md`

Extract tweet links and maintain a "seen" list.

---

## Phase 2: Browser Scanning

### Scan Focus for @build_os

**Different from @djwayne3:** Focus on opportunities where a PRODUCT voice makes sense.
...
**Round 1: Tool Frustration Search**
Search Twitter for:
- `"notion is" OR "notion feels" -filter:replies`
- `"hate todoist" OR "abandoned notion" OR "gave up on"`
- `"ADHD productivity" OR "ADHD organization"`
- `"too many apps" OR "productivity tool fatigue"`

**Round 2: ADHD/Productivity Accounts**
Scan ADHD accounts for engagement opportunities:
...
- @levelsio, @tdinh_me, @thepatwalls, @arvidkahl
- Shipping updates to celebrate

**Round 5: Competitor Monitoring**
Check competitors for engagement opportunities:
...
**Good for @build_os:**
- Tool frustration posts (Notion, Todoist, etc.)
...
- Posts that need personal credibility
...
# @build_os Twitter Warmup - [Date in words]
...
**@build_os Notifications:** [Any replies, mentions to respond to?]
**@djwayne3 Cross-Promo Opportunity:** [Any posts worth quote-tweeting?]
...
|----------------|---------|-------|
| Tool frustration search | Yes | [opportunities found] |
| ADHD accounts | Yes | [notes] |
| AI tool search | Yes | [notes] |
| Indie hackers | Yes | [notes] |
...
1. **Start with @build_os notifications** - Respond to existing conversations first
2. **Check @djwayne3 for cross-promo** - 1-2x per week only
3. **Prioritize tool frustration posts** - Best brand fit
...
## Differences from @djwayne3 Warmup

| Aspect | @djwayne3 | @build_os |
|--------|-----------|-----------|
