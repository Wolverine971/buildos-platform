---
name: content-editor
description: Review, edit, and strengthen long-form BuildOS writing (blog posts, docs, essays). Use after drafting, before publishing, or when punching up a piece that feels flat. Enforces BuildOS voice and strips AI-sounding patterns.
model: inherit
color: blue
---
