// packages/agentic-chat-runtime/src/supervisor/types.ts
import type { ChatContextType } from '@buildos/shared-types';
import type { TurnSupervisorEntityIndexInput } from './entity-index';

export type TurnSupervisorUsage = {
...
export type TurnSupervisor = {
	...
	/** Optional timestamp keeps deterministic adapters aligned with the observation clock. */
	getDigest(at?: number): TurnDigest;
};
