-- packages/shared-types/src/functions/delete_onto_project.sql
-- delete_onto_project(uuid)
-- Permanently delete an ontology project
-- Source: supabase/migrations/20260129_align_project_calendars_to_onto_projects.sql
