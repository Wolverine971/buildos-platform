// packages/shared-agent-ops/src/ontology/document-state.ts
import { DOCUMENT_STATES, type DocumentState } from './onto';
...
export function normalizeDocumentStateInput(state: unknown): DocumentState | undefined {
	...
	return DOCUMENT_STATE_SET.has(candidate as DocumentState)
		? (candidate as DocumentState)
		: undefined;
}
