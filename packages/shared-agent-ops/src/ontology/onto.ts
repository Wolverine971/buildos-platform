// packages/shared-agent-ops/src/ontology/onto.ts
/**
...
export const ProjectSchema = z.object({
	...
	icon_concept: z.string().nullable().optional(),
	icon_generated_at: z.string().datetime().nullable().optional(),
	icon_generation_source: z.enum(['auto', 'manual']).nullable().optional(),
	icon_generation_prompt: z.string().nullable().optional(),
	type_key: z.string(),
