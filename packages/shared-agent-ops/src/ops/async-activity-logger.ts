// packages/shared-agent-ops/src/ops/async-activity-logger.ts
//
// Core async activity logging extracted from apps/web (R2). Takes a supabase client
// + plain params; no Request/SvelteKit coupling. The getChangeSourceFromRequest /
// getChatSessionIdFromRequest helpers stay web-side.
/**
 ...
 * Usage:
 * ```ts
 * import { logActivityAsync } from '@buildos/shared-agent-ops';
 *
