// packages/shared-agent-ops/src/calendar/google-calendar-write.service.ts
...
export type GoogleCalendarWriteServiceOptions = {
...
export class GoogleCalendarWriteService {
	...
	constructor(
		...
		options: GoogleCalendarWriteServiceOptions
	) {
