// packages/shared-agent-ops/src/calendar/google-calendar-read.service.ts
import { google, type calendar_v3 } from 'googleapis';
import type { OAuth2Client } from 'google-auth-library';
import type { TypedSupabaseClient } from '@buildos/supabase-client';
import type { GoogleCalendarSourceEventIdentity } from '@buildos/shared-types';
import { toZonedTime } from 'date-fns-tz';
import type { GoogleCalendarAuthPort } from './google-calendar-source.service';
...
export type GoogleCalendarReadServiceOptions = {
	connectionService: GoogleCalendarAuthPort;
	targetService?: Pick<
...
export class GoogleCalendarReadService {
	private readonly connectionService: GoogleCalendarAuthPort;
	...
	constructor(admin: TypedSupabaseClient, options: GoogleCalendarReadServiceOptions) {
