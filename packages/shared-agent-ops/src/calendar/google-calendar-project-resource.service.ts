// packages/shared-agent-ops/src/calendar/google-calendar-project-resource.service.ts
import { google, type calendar_v3 } from 'googleapis';
import type { OAuth2Client } from 'google-auth-library';
import type { TypedSupabaseClient } from '@buildos/supabase-client';
import type {
	GoogleCalendarAuthPort,
	GoogleCalendarSourceRegistrationPort
...
export class GoogleCalendarProjectResourceService {
	...
	constructor(admin: TypedSupabaseClient, options: GoogleCalendarProjectResourceServiceOptions) {
